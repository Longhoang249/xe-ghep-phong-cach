...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const goldenCorridorIds = new Set(["hd-hp", "hd-qn", "hp-qn", "hd-cb", "hd-ha-long", "hd-van-don", "hd-cam-pha", "hd-uong-bi"]);
  ...
  return [
    {
      ...
      priority: 1,
      images: [
        absoluteUrl("/images/xe-ghep-phong-cach-hai-duong-hai-phong-quang-ninh.jpg"),
        absoluteUrl("/images/xe-ghep-phong-cach-khoang-xe.jpg"),
        absoluteUrl("/images/xe-ghep-phong-cach-don-tan-nha.jpg"),
        absoluteUrl("/images/hero-xe-ghep-phong-cach.png"),
        absoluteUrl("/og.png"),
      ],
    },
