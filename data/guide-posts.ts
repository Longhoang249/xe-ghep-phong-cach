  ...
  },
  {
    ...
    comparison: {
      ...
      rows: [
        ...
        { option: "Xe ghép Phong Cách", cost: "Dự kiến từ 200.000đ/người (chờ chốt)", time: "40 - 60 phút (chạy cao tốc)", convenience: "Đón tận nhà, trả tận nơi", pickupDropoff: "Trao đổi địa chỉ cụ thể hai đầu", bestFor: "Khách cần đón trả tận nơi, gia đình nhỏ" },
        { option: "Bao xe riêng Phong Cách", cost: "4 chỗ từ 500.000đ; 7 chỗ từ 650.000đ", time: "40 - 50 phút chạy thẳng", convenience: "Riêng xe, chủ động giờ giấc", pickupDropoff: "Đón trả theo yêu cầu mọi điểm", bestFor: "Gia đình, nhóm 3-7 người, nhiều đồ" },
      ],
    },
    sections: [
      ...
      { heading: "Chi phí xe ghép và bao xe: nguyên tắc giá sàn từ", paragraphs: ["Mức chi phí dự kiến khởi điểm cho tuyến Hải Phòng - Quảng Ninh: xe ghép từ 200.000đ/người; bao xe 4 chỗ từ 500.000đ/chuyến; bao xe 7 chỗ từ 650.000đ/chuyến; gửi hàng theo chuyến từ 150.000đ.", "Toàn bộ mức giá được hiểu là giá bắt đầu (starting price). Giá chuyến thực tế phụ thuộc vào vị trí đón/trả cụ thể tại Hải Phòng và Quảng Ninh, khung giờ đón và lượng hành lý. Nhà xe sẽ báo giá trọn gói minh bạch trước khi bạn quyết định đặt xe."] },
    ...
    faq: [
      ...
      { q: "Giá xe ghép Hải Phòng đi Quảng Ninh khoảng bao nhiêu?", a: "Giá xe ghép dự kiến khởi điểm từ 200.000đ/người. Giá thực tế phụ thuộc vào điểm đón tại Hải Phòng và điểm trả tại Hạ Long, Uông Bí hay Cẩm Phả." },
