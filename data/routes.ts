...
// Giá ghép đã được nhà xe xác nhận; giá bao xe được xác nhận lại trước chuyến.
export const routes: RoutePrice[] = [
  ...
  { id:"hd-hp",origin:"Hải Dương",destination:"Hải Phòng",slug:"xe-ghep-hai-duong-hai-phong",distanceKm:48,durationMinutes:65,sharedPrice:250000,private4Price:500000,private7Price:650000,parcelPrice:150000,region:"mien-bac",featured:true },
  { id:"hd-cb",origin:"Hải Dương",destination:"Cát Bi",slug:"xe-hai-duong-cat-bi",distanceKm:58,durationMinutes:75,sharedPrice:300000,private4Price:600000,private7Price:750000,parcelPrice:150000,tag:"Đưa đón sân bay",region:"san-bay" },
  ...
  { id:"hp-qn",origin:"Hải Phòng",destination:"Quảng Ninh",slug:"xe-ghep-hai-phong-quang-ninh",distanceKm:null,durationMinutes:null,sharedPrice:null,private4Price:null,private7Price:null,parcelPrice:null,region:"mien-bac",featured:true },
