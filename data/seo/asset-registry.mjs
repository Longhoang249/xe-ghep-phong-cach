...
export const seoAssets = Object.freeze([
  ...
  },
  {
    assetId: "MP-020",
    assetType: "MONEY_PAGE",
    slug: "xe-ghep-hai-duong-van-don",
    cluster: "CLUSTER-B",
    status: "PUBLISHED",
    legacy: false,
    dataKey: "hd-van-don",
    canonical: "/xe-ghep-hai-duong-van-don",
    publishedAt: "2026-09-10",
    lastReviewedAt: "2026-09-10",
    backfilledExisting: false,
    publicationHistory: Object.freeze([
      Object.freeze({ status: "REGISTERED", at: "2026-09-10", decision: "TASK-3C" }),
      Object.freeze({ status: "REVIEW", at: "2026-09-10", decision: "TASK-3C" }),
      Object.freeze({ status: "APPROVED", at: "2026-09-10", decision: "Owner Task 3C approval" }),
      Object.freeze({ status: "PUBLISHED", at: "2026-09-10", decision: "TASK-3C controlled publication" }),
    ]),
  },
  {
    assetId: "MP-021",
    assetType: "MONEY_PAGE",
    slug: "xe-ghep-hai-duong-cam-pha",
    cluster: "CLUSTER-B",
    status: "PUBLISHED",
    legacy: false,
    dataKey: "hd-cam-pha",
    canonical: "/xe-ghep-hai-duong-cam-pha",
    publishedAt: "2026-09-10",
    lastReviewedAt: "2026-09-10",
    backfilledExisting: false,
    publicationHistory: Object.freeze([
      Object.freeze({ status: "REGISTERED", at: "2026-09-10", decision: "TASK-3D-INTEGRATION" }),
      Object.freeze({ status: "REVIEW", at: "2026-09-10", decision: "TASK-3D-INTEGRATION" }),
      Object.freeze({ status: "APPROVED", at: "2026-09-10", decision: "Owner Task 3D approval" }),
      Object.freeze({ status: "PUBLISHED", at: "2026-09-10", decision: "TASK-3D-INTEGRATION controlled publication" }),
    ]),
  },
  {
    assetId: "MP-022",
    assetType: "MONEY_PAGE",
    slug: "xe-ghep-hai-duong-uong-bi",
    cluster: "CLUSTER-B",
    status: "PUBLISHED",
    legacy: false,
    dataKey: "hd-uong-bi",
    canonical: "/xe-ghep-hai-duong-uong-bi",
    publishedAt: "2026-09-10",
    lastReviewedAt: "2026-09-10",
    backfilledExisting: false,
    publicationHistory: Object.freeze([
      Object.freeze({ status: "REGISTERED", at: "2026-09-10", decision: "TASK-3E" }),
      Object.freeze({ status: "REVIEW", at: "2026-09-10", decision: "TASK-3E" }),
      Object.freeze({ status: "APPROVED", at: "2026-09-10", decision: "Owner pricing engine verification" }),
      Object.freeze({ status: "PUBLISHED", at: "2026-09-10", decision: "TASK-3E controlled publication" }),
    ]),
  },
