...
export const seoAssets = Object.freeze([
  ...
  { assetId: "SC-001", assetType: "SUPPORTING", slug: "cach-dat-xe-ghep-hai-duong-quang-ninh", cluster: "CLUSTER-B", status: "PUBLISHED", legacy: false, dataKey: "cach-dat-xe-ghep-hai-duong-quang-ninh", canonical: "/blog/cach-dat-xe-ghep-hai-duong-quang-ninh", publishedAt: null, lastReviewedAt: "2026-09-05", backfilledExisting: true },
  ...
  { assetId: "SC-005", assetType: "SUPPORTING", slug: "dat-xe-hai-duong-ha-noi-can-thong-tin-gi", cluster: "OTHER", status: "PUBLISHED", legacy: true, dataKey: "dat-xe-hai-duong-ha-noi-can-thong-tin-gi", canonical: "/blog/dat-xe-hai-duong-ha-noi-can-thong-tin-gi", publishedAt: null, lastReviewedAt: "2026-09-05", backfilledExisting: true },
  { assetId: "SC-006", assetType: "SUPPORTING", slug: "gui-hang-hai-duong-ha-noi-theo-chuyen", cluster: "OTHER", status: "PUBLISHED", legacy: true, dataKey: "gui-hang-hai-duong-ha-noi-theo-chuyen", canonical: "/blog/gui-hang-hai-duong-ha-noi-theo-chuyen", publishedAt: null, lastReviewedAt: "2026-09-05", backfilledExisting: true },
]);
