...
export const moneyPageUpgrades = Object.freeze({
  ...
  "hd-ha-long": Object.freeze({
    ...
    title: "Xe ghép Hải Dương - Hạ Long 400.000đ đón tận nơi | Phong Cách",
  ...
  "hd-cam-pha": Object.freeze({
    ...
    summaryItems: Object.freeze([
      ...
      "Cửa Ông: xe ghép 500.000đ/người; bao xe liên hệ",
    ...
    decisionRows: Object.freeze([
      ...
      Object.freeze({ need: "Đi khu vực Cửa Ông", guidance: "Xe ghép Hải Dương ⇄ Cửa Ông có giá chính xác 500.000đ/người. Bao xe riêng chưa có giá cố định; cần cung cấp địa chỉ cụ thể để xác nhận chuyến." }),
    ]),
    ...
    endpointBoundary: "Cửa Ông có giá xe ghép endpoint đã xác thực 500.000đ/người, nhưng chưa có giá bao xe hoặc gửi hàng riêng đã xác thực. Đây không phải URL tiền riêng; hãy gửi điểm đón và điểm trả cụ thể để kiểm tra chuyến.",
    ...
    faq: Object.freeze([
      ...
      Object.freeze({ q: "Giá xe Hải Dương - Cửa Ông bao nhiêu?", a: "Giá xe ghép Hải Dương ⇄ Cửa Ông là 500.000đ/người theo pricing engine hiện hành. Bao xe riêng và gửi hàng chưa có giá đã xác thực riêng; vui lòng cung cấp điểm đón và điểm trả cụ thể để kiểm tra chuyến." }),
