...
export function getRouteGoldContent(
  ...
  if (slug === "xe-ghep-hai-duong-quang-ninh") {
    ...
    const sharedPriceAmount = sharedPrice.replace(/^Từ\s+/i, "");
    const charter4PriceAmount = charter4Price.replace(/^Từ\s+/i, "");
